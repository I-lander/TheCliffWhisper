...
const NODES: SkillNode[] = [
    ...
    // Main: 51-60
    { id: 'vo_1', name: 'Fading Cradle', cost: 3, description: 'Birth rate -1/day',
      ...p(250, 0.10), apply: br(1) },
    { id: 'vo_s1', name: 'Withered Roots', cost: 2, description: 'Birth rate -1/day',
      ...p(250, 0.17), apply: br(1) },
    { id: 'vo_2', name: 'Barren Hearth', cost: 5, description: 'Birth rate -1/day',
      ...p(250, 0.25), apply: br(1) },
    { id: 'vo_s2', name: 'Forgotten Lullabies', cost: 2, description: 'Birth rate -1/day',
      ...p(248, 0.32), apply: br(1) },
    { id: 'vo_3', name: 'Womb of Despair', cost: 10, description: 'Birth rate -1/day',
      ...p(247, 0.40), apply: br(1) },
    { id: 'vo_s3', name: 'Diminishing Returns', cost: 3, description: 'Birth rate -1, Walk speed +5',
      ...p(245, 0.48), apply: (s, b) => { br(1)(s); ws(5)(s, b); } },
    { id: 'vo_4', name: 'Population Collapse', cost: 15, description: 'Birth rate -2/day',
      ...p(244, 0.58), apply: br(2) },
    { id: 'vo_s4', name: 'Echoing Silence', cost: 4, description: 'Birth rate -1/day',
      ...p(242, 0.67), apply: br(1) },
    ...
    { id: 'vo_a1', name: 'Childless Villages', cost: 6, description: 'Birth rate -1/day',
      ...p(258, 0.33), apply: br(1) },
    { id: 'vo_a2', name: 'Cursed Bloodlines', cost: 12, description: 'Birth rate -1/day',
      ...p(263, 0.45), apply: br(1) },
    ...
    { id: 'vo_b2', name: 'Severed Lineage', cost: 18, description: 'Birth rate -2/day',
      ...p(233, 0.75), apply: br(2) },
    { id: 'vo_b3', name: 'Void Womb', cost: 28, description: 'Birth rate -2/day',
      ...p(230, 0.87), apply: br(2) },
    // Extra nodes to fill: 67-68 don't exist, we have 16 nodes (51-66). Adding 2 more:
    { id: 'vo_s5', name: 'Desolate Horizon', cost: 3, description: 'Birth rate -1/day',
      ...p(246, 0.52, 0.02), apply: br(1) },
    { id: 'vo_s6', name: 'Last Generation', cost: 4, description: 'Birth rate -1/day',
      ...p(241, 0.72, -0.01), apply: br(1) },
    ...
    { id: 'vo_sx', name: 'Sterile Wind', cost: 2, description: 'Birth rate -1/day',
      ...p(252, 0.14), apply: br(1) },
    ...
    { id: 'xb_4', name: 'Barren Swarm', cost: 14, description: 'Drag +0.04, Birth rate -1',
      ...p(230, 0.50), apply: (s) => { dr(0.04)(s); br(1)(s); } },
    { id: 'xb_5', name: 'Automated Extinction', cost: 14, description: 'Birth rate -1, +1 AC',
      ...p(273, 0.45), apply: (s, b) => { br(1)(s); ac(1)(s, b); } },
