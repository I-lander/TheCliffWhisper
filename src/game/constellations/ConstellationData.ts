...
/*
  Constellation "The Ancient God" — 181 nodes (1 root + 5 branches × 33 nodes + 15 endgame).
  Central star with 5 radiating branches, each with trunk + 2 forks + ability sub-branch.
  Each Fork B has 3 additional endgame nodes (fb6-fb8) for late-game progression.
  ...
  Node index map:
    ...
    166-180     : Endgame extensions (3 per branch Fork B)
*/
...
const EDGE_IDS: [string, string][] = [
  ...
  ['ve_9','ve_fb1'],['ve_fb1','ve_fb2'],['ve_fb2','ve_fb3'],['ve_fb3','ve_fb4'],['ve_fb4','ve_fb5'],['ve_fb5','ve_fb6'],['ve_fb6','ve_fb7'],['ve_fb7','ve_fb8'],
  ...
  ['de_9','de_fb1'],['de_fb1','de_fb2'],['de_fb2','de_fb3'],['de_fb3','de_fb4'],['de_fb4','de_fb5'],['de_fb5','de_fb6'],['de_fb6','de_fb7'],['de_fb7','de_fb8'],
  ...
  ['co_9','co_fb1'],['co_fb1','co_fb2'],['co_fb2','co_fb3'],['co_fb3','co_fb4'],['co_fb4','co_fb5'],['co_fb5','co_fb6'],['co_fb6','co_fb7'],['co_fb7','co_fb8'],
  ...
  ['ma_9','ma_fb1'],['ma_fb1','ma_fb2'],['ma_fb2','ma_fb3'],['ma_fb3','ma_fb4'],['ma_fb4','ma_fb5'],['ma_fb5','ma_fb6'],['ma_fb6','ma_fb7'],['ma_fb7','ma_fb8'],
  ...
  ['ge_9','ge_fb1'],['ge_fb1','ge_fb2'],['ge_fb2','ge_fb3'],['ge_fb3','ge_fb4'],['ge_fb4','ge_fb5'],['ge_fb5','ge_fb6'],['ge_fb6','ge_fb7'],['ge_fb7','ge_fb8'],
...
const NODES: SkillNode[] = [
  ...
  { id: 've_5', name: 'Driven Forward', cost: 90, description: 'Walk speed +7',
    ...p(VELOCITY_DEG, trunkR(4)), apply: ws(7) },
  { id: 've_6', name: 'Rushing Tide', cost: 250, description: 'Walk speed +7',
    ...p(VELOCITY_DEG, trunkR(5)), apply: ws(7) },
  { id: 've_7', name: 'Relentless Gait', cost: 600, description: 'Walk speed +8',
    ...p(VELOCITY_DEG, trunkR(6)), apply: ws(8) },
  { id: 've_8', name: 'Blinding Speed', cost: 1500, description: 'Walk speed +10',
    ...p(VELOCITY_DEG, trunkR(7)), apply: ws(10) },
  { id: 've_9', name: 'Wind Walker', cost: 4000, description: 'Walk speed +10',
    ...p(VELOCITY_DEG, trunkR(8)), apply: ws(10) },
  { id: 've_10', name: 'Terminal Velocity', cost: 16000, description: 'Walk speed +12',
    ...p(VELOCITY_DEG, trunkR(9)), apply: ws(12) },
  { id: 've_11', name: 'Beyond Mortal Pace', cost: 50000, description: 'Walk speed +12',
    ...p(VELOCITY_DEG, trunkR(10)), apply: ws(12) },
  { id: 've_12', name: 'Sonic Pilgrimage', cost: 150000, description: 'Walk speed +15',
    ...p(VELOCITY_DEG, trunkR(11)), apply: ws(15) },
  { id: 've_13', name: 'Lightspeed Lemmings', cost: 500000, description: 'Walk speed +15',
    ...p(VELOCITY_DEG, trunkR(12)), apply: ws(15) },
  { id: 've_14', name: 'Warp March', cost: 1500000, description: 'Walk speed +18',
    ...p(VELOCITY_DEG, trunkR(13)), apply: ws(18) },
  { id: 've_15', name: 'The Stampede Eternal', cost: 5000000, description: 'Walk speed +20',
    ...p(VELOCITY_DEG, trunkR(14)), apply: ws(20) },

  // Fork A (from node 5, 6 nodes): +5,+6,+8,+10,+12,+15 = +56
  { id: 've_fa1', name: 'Zephyr\'s Lure', cost: 75, description: 'Walk speed +5',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(0)), apply: ws(5) },
  { id: 've_fa2', name: 'Windborne Panic', cost: 300, description: 'Walk speed +6',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(1)), apply: ws(6) },
  { id: 've_fa3', name: 'Gale of No Return', cost: 1200, description: 'Walk speed +8',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(2)), apply: ws(8) },
  { id: 've_fa4', name: 'Cyclone Step', cost: 6000, description: 'Walk speed +10',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(3)), apply: ws(10) },
  { id: 've_fa5', name: 'Tempest Rush', cost: 35000, description: 'Walk speed +12',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(4)), apply: ws(12) },
  { id: 've_fa6', name: 'Hurricane Charge', cost: 200000, description: 'Walk speed +15',
    ...p(VELOCITY_DEG + FORK_A_OFFSET, forkAR(5)), apply: ws(15) },

  // Fork B (from node 9, 5 nodes): +4,+5,+6,+7,+8 = +30 (minor speed + birth rate combos)
  { id: 've_fb1', name: 'Frantic March', cost: 3000, description: 'Walk speed +4, birth rate +20/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(0)), apply: (s) => { s.walkSpeed += 4; s.birthRate += 20; } },
  { id: 've_fb2', name: 'Screaming Sprint', cost: 20000, description: 'Walk speed +5, birth rate +50/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(1)), apply: (s) => { s.walkSpeed += 5; s.birthRate += 50; } },
  { id: 've_fb3', name: 'Panic Exodus', cost: 75000, description: 'Walk speed +6, birth rate +150/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(2)), apply: (s) => { s.walkSpeed += 6; s.birthRate += 150; } },
  { id: 've_fb4', name: 'Death Race', cost: 400000, description: 'Walk speed +7, birth rate +500/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(3)), apply: (s) => { s.walkSpeed += 7; s.birthRate += 500; } },
  { id: 've_fb5', name: 'The Endless Stampede', cost: 2000000, description: 'Walk speed +8, birth rate +1500/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(4)), apply: (s) => { s.walkSpeed += 8; s.birthRate += 1500; } },

  // Ability: Frenzy Pulse (from node 6, 7 nodes)
  { id: 've_ab1', name: 'Frenzy Pulse', cost: 200, description: 'Unlock: Walk speed x2 for 8s (cd 45s)',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(0)), apply: ab('frenzy_pulse') },
  { id: 've_ab2', name: 'Sustained Frenzy', cost: 700, description: 'Frenzy Pulse duration +3s',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(1)), apply: (_s, b) => { b.frenzyPulse.duration += 3000; } },
  { id: 've_ab3', name: 'Amplified Frenzy', cost: 2500, description: 'Frenzy Pulse multiplier x2.5',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(2)), apply: (_s, b) => { b.frenzyPulse.multiplier = 2.5; } },
  { id: 've_ab4', name: 'Relentless Frenzy', cost: 10000, description: 'Frenzy Pulse cooldown -10s',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(3)), apply: (_s, b) => { b.frenzyPulse.cooldown -= 10000; } },
  { id: 've_ab5', name: 'Overwhelming Frenzy', cost: 50000, description: 'Frenzy Pulse x3, duration +2s',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(4)), apply: (_s, b) => { b.frenzyPulse.multiplier = 3; b.frenzyPulse.duration += 2000; } },
  { id: 've_ab6', name: 'Eternal Frenzy', cost: 350000, description: 'Frenzy Pulse cd -10s, duration +2s',
    ...p(VELOCITY_DEG + ABILITY_OFFSET, abilR(5)), apply: (_s, b) => { b.frenzyPulse.cooldown -= 10000; b.frenzyPulse.duration += 2000; } },
  { id: 've_ab7', name: 'Godspeed', cost: 1500000, description: 'Frenzy Pulse x4, cd -5s, duration +1s',
  ...
  { id: 'de_5', name: 'Fading Hope', cost: 90, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG, trunkR(4)), apply: tb(0.01) },
  { id: 'de_6', name: 'Conviction', cost: 250, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG, trunkR(5)), apply: tb(0.01) },
  { id: 'de_7', name: 'Blind Devotion', cost: 600, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG, trunkR(6)), apply: tb(0.01) },
  { id: 'de_8', name: 'No Return', cost: 1500, description: 'Turn-back rate -0.015',
    ...p(DEVOTION_DEG, trunkR(7)), apply: tb(0.015) },
  { id: 'de_9', name: 'The Abyss Calls', cost: 4000, description: 'Turn-back rate -0.015',
    ...p(DEVOTION_DEG, trunkR(8)), apply: tb(0.015) },
  { id: 'de_10', name: 'Absolute Faith', cost: 16000, description: 'Turn-back rate -0.015',
    ...p(DEVOTION_DEG, trunkR(9)), apply: tb(0.015) },
  { id: 'de_11', name: 'Unwavering Resolve', cost: 50000, description: 'Turn-back rate -0.02',
    ...p(DEVOTION_DEG, trunkR(10)), apply: tb(0.02) },
  { id: 'de_12', name: 'Shattered Will', cost: 150000, description: 'Turn-back rate -0.02',
    ...p(DEVOTION_DEG, trunkR(11)), apply: tb(0.02) },
  { id: 'de_13', name: 'Mind Erased', cost: 500000, description: 'Turn-back rate -0.02',
    ...p(DEVOTION_DEG, trunkR(12)), apply: tb(0.02) },
  { id: 'de_14', name: 'Empty Vessel', cost: 1500000, description: 'Turn-back rate -0.02',
    ...p(DEVOTION_DEG, trunkR(13)), apply: tb(0.02) },
  { id: 'de_15', name: 'Total Surrender', cost: 5000000, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG, trunkR(14)), apply: tb(0.01) },

  // Fork A (from node 5, 6 nodes): -0.01 x6 = -0.06
  { id: 'de_fa1', name: 'Seeds of Surrender', cost: 75, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(0)), apply: tb(0.01) },
  { id: 'de_fa2', name: 'Congregation of Shadows', cost: 300, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(1)), apply: tb(0.01) },
  { id: 'de_fa3', name: 'Mass Hypnosis', cost: 1200, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(2)), apply: tb(0.01) },
  { id: 'de_fa4', name: 'Unbreakable Trance', cost: 6000, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(3)), apply: tb(0.01) },
  { id: 'de_fa5', name: 'Puppeteer\'s Thread', cost: 35000, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(4)), apply: tb(0.01) },
  { id: 'de_fa6', name: 'Absolute Control', cost: 200000, description: 'Turn-back rate -0.01',
    ...p(DEVOTION_DEG + FORK_A_OFFSET, forkAR(5)), apply: tb(0.01) },

  // Fork B (from node 9, 5 nodes): drag rate combos
  { id: 'de_fb1', name: 'Silenced Doubt', cost: 3000, description: 'Turn-back -0.01, drag +0.02',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(0)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.02; } },
  { id: 'de_fb2', name: 'Covenant of Falling', cost: 20000, description: 'Turn-back -0.01, drag +0.03',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(1)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.03; } },
  { id: 'de_fb3', name: 'Absolute Obedience', cost: 75000, description: 'Turn-back -0.01, drag +0.03',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(2)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.03; } },
  { id: 'de_fb4', name: 'Hive Mind', cost: 400000, description: 'Turn-back -0.01, drag +0.04',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(3)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.04; } },
  { id: 'de_fb5', name: 'One Will', cost: 2000000, description: 'Turn-back -0.01, drag +0.05',
  ...
  { id: 'de_ab1', name: 'Void Call', cost: 200, description: 'Unlock: Turn-back = 0 for 5s (cd 30s)',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(0)), apply: ab('void_call') },
  { id: 'de_ab2', name: 'Extended Silence', cost: 700, description: 'Void Call duration +3s',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(1)), apply: (_s, b) => { b.voidCall.duration += 3000; } },
  { id: 'de_ab3', name: 'Quickened Call', cost: 2500, description: 'Void Call cooldown -4s',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(2)), apply: (_s, b) => { b.voidCall.cooldown -= 4000; } },
  { id: 'de_ab4', name: 'Lingering Void', cost: 10000, description: 'Void Call duration +3s',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(3)), apply: (_s, b) => { b.voidCall.duration += 3000; } },
  { id: 'de_ab5', name: 'Resonant Void', cost: 50000, description: 'Void Call cooldown -4s',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(4)), apply: (_s, b) => { b.voidCall.cooldown -= 4000; } },
  { id: 'de_ab6', name: 'Eternal Void', cost: 350000, description: 'Void Call duration +3s, cd -4s',
    ...p(DEVOTION_DEG + ABILITY_OFFSET, abilR(5)), apply: (_s, b) => { b.voidCall.duration += 3000; b.voidCall.cooldown -= 4000; } },
  { id: 'de_ab7', name: 'Absolute Void', cost: 1500000, description: 'Void Call duration +3s, cd -3s',
  ...
  { id: 'co_5', name: 'Panic Spread', cost: 90, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG, trunkR(4)), apply: dr(0.02) },
  { id: 'co_6', name: 'Chain Reaction', cost: 250, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG, trunkR(5)), apply: dr(0.02) },
  { id: 'co_7', name: 'Mob Mentality', cost: 600, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG, trunkR(6)), apply: dr(0.02) },
  { id: 'co_8', name: 'Hysteria', cost: 1500, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG, trunkR(7)), apply: dr(0.02) },
  { id: 'co_9', name: 'Cascade Effect', cost: 4000, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG, trunkR(8)), apply: dr(0.02) },
  { id: 'co_10', name: 'Mass Psychosis', cost: 16000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG, trunkR(9)), apply: dr(0.03) },
  { id: 'co_11', name: 'Fever Dream', cost: 50000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG, trunkR(10)), apply: dr(0.03) },
  { id: 'co_12', name: 'Collective Madness', cost: 150000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG, trunkR(11)), apply: dr(0.03) },
  { id: 'co_13', name: 'Plague of Despair', cost: 500000, description: 'Drag rate +0.04',
    ...p(CONTAGION_DEG, trunkR(12)), apply: dr(0.04) },
  { id: 'co_14', name: 'Total Infection', cost: 1500000, description: 'Drag rate +0.04',
    ...p(CONTAGION_DEG, trunkR(13)), apply: dr(0.04) },
  { id: 'co_15', name: 'Apocalyptic Spread', cost: 5000000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG, trunkR(14)), apply: dr(0.03) },

  // Fork A (from node 5, 6 nodes): +0.02 x3, +0.03 x3 = +0.15
  { id: 'co_fa1', name: 'Curious Bystanders', cost: 75, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(0)), apply: dr(0.02) },
  { id: 'co_fa2', name: 'Peer Pressure', cost: 300, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(1)), apply: dr(0.02) },
  { id: 'co_fa3', name: 'Social Contagion', cost: 1200, description: 'Drag rate +0.02',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(2)), apply: dr(0.02) },
  { id: 'co_fa4', name: 'Mass Delusion', cost: 6000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(3)), apply: dr(0.03) },
  { id: 'co_fa5', name: 'Psychic Plague', cost: 35000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(4)), apply: dr(0.03) },
  { id: 'co_fa6', name: 'Unstoppable Panic', cost: 200000, description: 'Drag rate +0.03',
    ...p(CONTAGION_DEG + FORK_A_OFFSET, forkAR(5)), apply: dr(0.03) },

  // Fork B (from node 9, 5 nodes): birth rate combos
  { id: 'co_fb1', name: 'Ripple Effect', cost: 3000, description: 'Drag +0.02, birth +30/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(0)), apply: (s) => { s.dragRate += 0.02; s.birthRate += 30; } },
  { id: 'co_fb2', name: 'Undertow', cost: 20000, description: 'Drag +0.03, birth +80/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(1)), apply: (s) => { s.dragRate += 0.03; s.birthRate += 80; } },
  { id: 'co_fb3', name: 'Tsunami of Flesh', cost: 75000, description: 'Drag +0.03, birth +250/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(2)), apply: (s) => { s.dragRate += 0.03; s.birthRate += 250; } },
  { id: 'co_fb4', name: 'Tidal Wave', cost: 400000, description: 'Drag +0.04, birth +800/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(3)), apply: (s) => { s.dragRate += 0.04; s.birthRate += 800; } },
  { id: 'co_fb5', name: 'World Flood', cost: 2000000, description: 'Drag +0.05, birth +3000/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(4)), apply: (s) => { s.dragRate += 0.05; s.birthRate += 3000; } },

  // Ability: Dark Wave (from node 6, 7 nodes)
  { id: 'co_ab1', name: 'Dark Wave', cost: 200, description: 'Unlock: Spawn 5 humans (cd 30s)',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(0)), apply: ab('dark_wave') },
  { id: 'co_ab2', name: 'Swelling Tide', cost: 700, description: 'Dark Wave +3 humans',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(1)), apply: (_s, b) => { b.darkWave.count += 3; } },
  { id: 'co_ab3', name: 'Quickened Tide', cost: 2500, description: 'Dark Wave cooldown -5s',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(2)), apply: (_s, b) => { b.darkWave.cooldown -= 5000; } },
  { id: 'co_ab4', name: 'Crashing Wave', cost: 10000, description: 'Dark Wave +5 humans',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(3)), apply: (_s, b) => { b.darkWave.count += 5; } },
  { id: 'co_ab5', name: 'Relentless Surge', cost: 50000, description: 'Dark Wave cooldown -5s',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(4)), apply: (_s, b) => { b.darkWave.cooldown -= 5000; } },
  { id: 'co_ab6', name: 'Apocalyptic Flood', cost: 350000, description: 'Dark Wave +7 humans, cd -5s',
    ...p(CONTAGION_DEG + ABILITY_OFFSET, abilR(5)), apply: (_s, b) => { b.darkWave.count += 7; b.darkWave.cooldown -= 5000; } },
  { id: 'co_ab7', name: 'Endless Deluge', cost: 1500000, description: 'Dark Wave +10 humans, cd -5s',
  ...
  { id: 'ma_5', name: 'Precision Gears', cost: 90, description: 'Click cooldown -30ms',
    ...p(MACHINERY_DEG, trunkR(4)), apply: cc(30) },
  { id: 'ma_6', name: 'Third Automaton', cost: 250, description: '+1 auto-clicker',
    ...p(MACHINERY_DEG, trunkR(5)), apply: ac(1) },
  { id: 'ma_7', name: 'Clockwork Engine', cost: 600, description: 'Click cooldown -40ms',
    ...p(MACHINERY_DEG, trunkR(6)), apply: cc(40) },
  { id: 'ma_8', name: 'Fourth Automaton', cost: 1500, description: '+1 auto-clicker',
    ...p(MACHINERY_DEG, trunkR(7)), apply: ac(1) },
  { id: 'ma_9', name: 'Perpetual Motion', cost: 4000, description: 'Click cooldown -50ms',
    ...p(MACHINERY_DEG, trunkR(8)), apply: cc(50) },
  { id: 'ma_10', name: 'The Machine God', cost: 16000, description: '+2 auto-clickers',
    ...p(MACHINERY_DEG, trunkR(9)), apply: ac(2) },
  { id: 'ma_11', name: 'Quantum Gears', cost: 50000, description: 'Click cooldown -60ms',
    ...p(MACHINERY_DEG, trunkR(10)), apply: cc(60) },
  { id: 'ma_12', name: 'Assembly Line', cost: 150000, description: 'Click cooldown -70ms',
    ...p(MACHINERY_DEG, trunkR(11)), apply: cc(70) },
  { id: 'ma_13', name: 'Factory of Doom', cost: 500000, description: '+1 auto-clicker',
    ...p(MACHINERY_DEG, trunkR(12)), apply: ac(1) },
  { id: 'ma_14', name: 'Industrial Revolution', cost: 1500000, description: 'Click cooldown -80ms, +1 AC',
    ...p(MACHINERY_DEG, trunkR(13)), apply: (s, b) => { s.clickCooldown = Math.max(100, s.clickCooldown - 80); b.autoClickerCount += 1; } },
  { id: 'ma_15', name: 'Singularity Engine', cost: 5000000, description: 'Click cooldown -80ms, +1 AC',
  ...
  { id: 'ma_fa1', name: 'Swift Mechanisms', cost: 75, description: 'Click cooldown -30ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(0)), apply: cc(30) },
  { id: 'ma_fa2', name: 'Overclocked Abyss', cost: 300, description: 'Click cooldown -40ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(1)), apply: cc(40) },
  { id: 'ma_fa3', name: 'Temporal Compression', cost: 1200, description: 'Click cooldown -50ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(2)), apply: cc(50) },
  { id: 'ma_fa4', name: 'Infinite Gears', cost: 6000, description: 'Click cooldown -60ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(3)), apply: cc(60) },
  { id: 'ma_fa5', name: 'Warp Drive', cost: 35000, description: 'Click cooldown -70ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(4)), apply: cc(70) },
  { id: 'ma_fa6', name: 'Time Collapse', cost: 200000, description: 'Click cooldown -80ms',
    ...p(MACHINERY_DEG + FORK_A_OFFSET, forkAR(5)), apply: cc(80) },

  // Fork B (from node 9, 5 nodes): auto-clicker focused — total +9 AC
  { id: 'ma_fb1', name: 'Shadow Foreman', cost: 3000, description: '+1 auto-clicker',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(0)), apply: ac(1) },
  { id: 'ma_fb2', name: 'Necromantic Workshop', cost: 20000, description: '+2 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(1)), apply: ac(2) },
  { id: 'ma_fb3', name: 'Army of Oblivion', cost: 75000, description: '+2 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(2)), apply: ac(2) },
  { id: 'ma_fb4', name: 'Legion of Gears', cost: 400000, description: '+2 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(3)), apply: ac(2) },
  { id: 'ma_fb5', name: 'The Swarm', cost: 2000000, description: '+2 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(4)), apply: ac(2) },

  // Ability: Soul Harvest (from node 6, 7 nodes)
  { id: 'ma_ab1', name: 'Soul Harvest', cost: 200, description: 'Unlock: Souls x2 for 10s (cd 40s)',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(0)), apply: ab('soul_harvest') },
  { id: 'ma_ab2', name: 'Extended Harvest', cost: 700, description: 'Soul Harvest duration +3s',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(1)), apply: (_s, b) => { b.soulHarvest.duration += 3000; } },
  { id: 'ma_ab3', name: 'Amplified Harvest', cost: 2500, description: 'Soul Harvest x2.5',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(2)), apply: (_s, b) => { b.soulHarvest.multiplier = 2.5; } },
  { id: 'ma_ab4', name: 'Quickened Harvest', cost: 10000, description: 'Soul Harvest cooldown -8s',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(3)), apply: (_s, b) => { b.soulHarvest.cooldown -= 8000; } },
  { id: 'ma_ab5', name: 'Overwhelming Harvest', cost: 50000, description: 'Soul Harvest x3, duration +3s',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(4)), apply: (_s, b) => { b.soulHarvest.multiplier = 3; b.soulHarvest.duration += 3000; } },
  { id: 'ma_ab6', name: 'Eternal Harvest', cost: 350000, description: 'Soul Harvest cd -8s, duration +2s',
    ...p(MACHINERY_DEG + ABILITY_OFFSET, abilR(5)), apply: (_s, b) => { b.soulHarvest.cooldown -= 8000; b.soulHarvest.duration += 2000; } },
  { id: 'ma_ab7', name: 'Infinite Reaping', cost: 1500000, description: 'Soul Harvest x4, cd -5s, duration +2s',
  ...
  // Trunk (15 nodes): soulMultiplier — total +18.7 (from 1 → 19.7)
  ...
  { id: 'ge_5', name: 'Reaping Wind', cost: 90, description: 'Soul multiplier +0.5',
    ...p(GENESIS_DEG, trunkR(4)), apply: sm(0.5) },
  { id: 'ge_6', name: 'Soul Furnace', cost: 250, description: 'Soul multiplier +0.5',
    ...p(GENESIS_DEG, trunkR(5)), apply: sm(0.5) },
  { id: 'ge_7', name: 'Dark Harvest', cost: 600, description: 'Soul multiplier +0.8',
    ...p(GENESIS_DEG, trunkR(6)), apply: sm(0.8) },
  { id: 'ge_8', name: 'Essence Drain', cost: 1500, description: 'Soul multiplier +1',
    ...p(GENESIS_DEG, trunkR(7)), apply: sm(1) },
  { id: 'ge_9', name: 'Death\'s Bounty', cost: 4000, description: 'Soul multiplier +1.2',
    ...p(GENESIS_DEG, trunkR(8)), apply: sm(1.2) },
  { id: 'ge_10', name: 'The Soul Singularity', cost: 16000, description: 'Soul multiplier +1.5',
    ...p(GENESIS_DEG, trunkR(9)), apply: sm(1.5) },
  { id: 'ge_11', name: 'Void Harvester', cost: 50000, description: 'Soul multiplier +2',
    ...p(GENESIS_DEG, trunkR(10)), apply: sm(2) },
  { id: 'ge_12', name: 'Cosmic Reaper', cost: 150000, description: 'Soul multiplier +2.5',
    ...p(GENESIS_DEG, trunkR(11)), apply: sm(2.5) },
  { id: 'ge_13', name: 'Dimensional Rift', cost: 500000, description: 'Soul multiplier +3',
    ...p(GENESIS_DEG, trunkR(12)), apply: sm(3) },
  { id: 'ge_14', name: 'Infinity Engine', cost: 1500000, description: 'Soul multiplier +3',
    ...p(GENESIS_DEG, trunkR(13)), apply: sm(3) },
  { id: 'ge_15', name: 'The God Eater', cost: 5000000, description: 'Soul multiplier +2',
    ...p(GENESIS_DEG, trunkR(14)), apply: sm(2) },

  // Fork A (from node 5, 6 nodes): soulMultiplier + birthratePerSec combos — total +6.6 soul, +20/s
  { id: 'ge_fa1', name: 'Greedy Grasp', cost: 75, description: 'Soul mult +0.3, births +1/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(0)), apply: (s, b) => { b.soulMultiplier += 0.3; s.birthratePerSec += 1; } },
  { id: 'ge_fa2', name: 'Soul Taxation', cost: 300, description: 'Soul mult +0.5, births +1/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(1)), apply: (s, b) => { b.soulMultiplier += 0.5; s.birthratePerSec += 1; } },
  { id: 'ge_fa3', name: 'Spiritual Monopoly', cost: 1200, description: 'Soul mult +0.8, births +2/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(2)), apply: (s, b) => { b.soulMultiplier += 0.8; s.birthratePerSec += 2; } },
  { id: 'ge_fa4', name: 'Philosopher\'s Reap', cost: 6000, description: 'Soul mult +1, births +3/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(3)), apply: (s, b) => { b.soulMultiplier += 1; s.birthratePerSec += 3; } },
  { id: 'ge_fa5', name: 'Eternal Hunger', cost: 35000, description: 'Soul mult +1.5, births +5/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(4)), apply: (s, b) => { b.soulMultiplier += 1.5; s.birthratePerSec += 5; } },
  { id: 'ge_fa6', name: 'Omnivorous God', cost: 200000, description: 'Soul mult +2.5, births +8/s',
    ...p(GENESIS_DEG + FORK_A_OFFSET, forkAR(5)), apply: (s, b) => { b.soulMultiplier += 2.5; s.birthratePerSec += 8; } },

  // Fork B (from node 9, 5 nodes): DEATH MULTIPLIER — multiplicative
  // x2 → x3 → x5 → x10 → x20 = total x6,000
  { id: 'ge_fb1', name: 'Ticking Clock', cost: 1800, description: 'Death multiplier x2',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(0)), apply: dm(2) },
  { id: 'ge_fb2', name: 'Mass Graves', cost: 20000, description: 'Death multiplier x3',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(1)), apply: dm(3) },
  { id: 'ge_fb3', name: 'Reaper\'s Scythe', cost: 200000, description: 'Death multiplier x5',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(2)), apply: dm(5) },
  { id: 'ge_fb4', name: 'Apocalypse Herald', cost: 2000000, description: 'Death multiplier x10',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(3)), apply: dm(10) },
  { id: 'ge_fb5', name: 'Extinction Engine', cost: 10000000, description: 'Death multiplier x20',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(4)), apply: dm(20) },

  // Ability: Silence (from node 6, 7 nodes)
  { id: 'ge_ab1', name: 'Silence', cost: 200, description: 'Unlock: birthratePerSec = 0 for 15s (cd 60s)',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(0)), apply: ab('silence') },
  { id: 'ge_ab2', name: 'Extended Silence', cost: 700, description: 'Silence duration +3s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(1)), apply: (_s, b) => { b.silence.duration += 3000; } },
  { id: 'ge_ab3', name: 'Quickened Silence', cost: 2500, description: 'Silence cooldown -8s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(2)), apply: (_s, b) => { b.silence.cooldown -= 8000; } },
  { id: 'ge_ab4', name: 'Deep Silence', cost: 10000, description: 'Silence duration +3s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(3)), apply: (_s, b) => { b.silence.duration += 3000; } },
  { id: 'ge_ab5', name: 'Resonant Silence', cost: 50000, description: 'Silence cooldown -8s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(4)), apply: (_s, b) => { b.silence.cooldown -= 8000; } },
  { id: 'ge_ab6', name: 'Eternal Silence', cost: 350000, description: 'Silence duration +2s, cd -6s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(5)), apply: (_s, b) => { b.silence.duration += 2000; b.silence.cooldown -= 6000; } },
  { id: 'ge_ab7', name: 'The Great Mute', cost: 1500000, description: 'Silence duration +2s, cd -5s',
    ...p(GENESIS_DEG + ABILITY_OFFSET, abilR(6)), apply: (_s, b) => { b.silence.duration += 2000; b.silence.cooldown -= 5000; } },

  // ═══════════════════════════════════════════════════════════════
  // ENDGAME EXTENSIONS — 3 new nodes per branch Fork B (nodes 166-180)
  // Expensive late-game upgrades to ensure smooth progression to victory
  // ═══════════════════════════════════════════════════════════════

  // Velocity Fork B extensions: walk speed + birth rate
  { id: 've_fb6', name: 'Sonic Pilgrims', cost: 3000000, description: 'Walk speed +12, birth +3000/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(5)), apply: (s) => { s.walkSpeed += 12; s.birthRate += 3000; } },
  { id: 've_fb7', name: 'Lightspeed Exodus', cost: 8000000, description: 'Walk speed +18, birth +5000/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(6)), apply: (s) => { s.walkSpeed += 18; s.birthRate += 5000; } },
  { id: 've_fb8', name: 'The Final Sprint', cost: 25000000, description: 'Walk speed +25, birth +10000/day',
    ...p(VELOCITY_DEG + FORK_B_OFFSET, forkBR(7)), apply: (s) => { s.walkSpeed += 25; s.birthRate += 10000; } },

  // Devotion Fork B extensions: turn-back reduction + drag
  { id: 'de_fb6', name: 'Absolute Servitude', cost: 3000000, description: 'Turn-back -0.01, drag +0.06',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(5)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.06; } },
  { id: 'de_fb7', name: 'Hollow Vessels', cost: 8000000, description: 'Turn-back -0.01, drag +0.08',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(6)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.08; } },
  { id: 'de_fb8', name: 'The Puppeteer God', cost: 25000000, description: 'Turn-back -0.01, drag +0.10',
    ...p(DEVOTION_DEG + FORK_B_OFFSET, forkBR(7)), apply: (s) => { s.turnBackRate = Math.max(TURN_BACK_MIN, s.turnBackRate - 0.01); s.dragRate += 0.10; } },

  // Contagion Fork B extensions: drag + birth rate
  { id: 'co_fb6', name: 'Extinction Tide', cost: 3000000, description: 'Drag +0.06, birth +5000/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(5)), apply: (s) => { s.dragRate += 0.06; s.birthRate += 5000; } },
  { id: 'co_fb7', name: 'Plague Eternal', cost: 8000000, description: 'Drag +0.08, birth +8000/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(6)), apply: (s) => { s.dragRate += 0.08; s.birthRate += 8000; } },
  { id: 'co_fb8', name: 'World Ender', cost: 25000000, description: 'Drag +0.10, birth +15000/day',
    ...p(CONTAGION_DEG + FORK_B_OFFSET, forkBR(7)), apply: (s) => { s.dragRate += 0.10; s.birthRate += 15000; } },

  // Machinery Fork B extensions: auto-clickers
  { id: 'ma_fb6', name: 'Clockwork Legion', cost: 3000000, description: '+3 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(5)), apply: ac(3) },
  { id: 'ma_fb7', name: 'The Machine Swarm', cost: 8000000, description: '+4 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(6)), apply: ac(4) },
  { id: 'ma_fb8', name: 'Infinite Automatons', cost: 25000000, description: '+5 auto-clickers',
    ...p(MACHINERY_DEG + FORK_B_OFFSET, forkBR(7)), apply: ac(5) },

  // Genesis Fork B extensions: death multiplier
  { id: 'ge_fb6', name: 'Horseman of Death', cost: 3000000, description: 'Death multiplier x2',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(5)), apply: dm(2) },
  { id: 'ge_fb7', name: 'The Last Plague', cost: 8000000, description: 'Death multiplier x3',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(6)), apply: dm(3) },
  { id: 'ge_fb8', name: 'Total Extinction', cost: 25000000, description: 'Death multiplier x5',
    ...p(GENESIS_DEG + FORK_B_OFFSET, forkBR(7)), apply: dm(5) },
];
